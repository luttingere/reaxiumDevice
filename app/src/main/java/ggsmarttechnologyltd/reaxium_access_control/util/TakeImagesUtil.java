...
/**
 * Created by Eduardo Luttinger on 11/12/2015.
 */
public class TakeImagesUtil {

    private static final int DEFAULT_MIN_WIDTH_QUALITY = 400;        // min pixels
    private static final String TAG = "TakeImagesUtil";
    private static final String TEMP_IMAGE_NAME = "tempImage";


    public static int minWidthQuality = DEFAULT_MIN_WIDTH_QUALITY;

    public static String getStringBase64Image(Bitmap bmp){
    ...
    public static Intent getPickImageIntent(Context context) {
        ...
        if (intentList.size() > 0) {
            chooserIntent = Intent.createChooser(intentList.remove(intentList.size() - 1), "Selecione una photo");
