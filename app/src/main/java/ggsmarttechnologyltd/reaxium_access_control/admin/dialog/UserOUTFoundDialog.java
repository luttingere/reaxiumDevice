 ...
 */
public class UserOUTFoundDialog extends Dialog {
    ...
    public UserOUTFoundDialog(Context context) {
        super(context);
        this.context = context;
    }

    public UserOUTFoundDialog(Context context, int themeResId) {
        super(context, themeResId);
        this.context = context;
    }

    protected UserOUTFoundDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_out_found_dialog);
        setViews();
        setEvents();
    }
